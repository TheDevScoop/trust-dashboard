...
export const REPO_GRADES: RepoGrade[] = [
  ...
  makeRepoGrade("babylon", "Babylon Prediction MMO", "community" as RepoGrade["org"], "game" as RepoGrade["category"],
  ...
  makeRepoGrade("auto.fun", "Auto.fun Launchpad", "elizaOS", "official-tool" as RepoGrade["category"],
